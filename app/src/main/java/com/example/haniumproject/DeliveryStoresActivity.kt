...
import com.example.haniumproject.databinding.ActivityDeliveryStoresBinding
...
class DeliveryStoresActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val list = listOf(ChickenFragment(),PizzaFragment(),HamburgerFragment(),ChineseFoodFragment(),WesternFoodFragment(),RestFoodFragment())
